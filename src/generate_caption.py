...
いちばん大事なこと:
- スマホで流し読みしている人が、一度読んだだけで意味が分かる文章にしてください。
  説明文や論文のような書き言葉ではなく、人に話すときの言葉で書きます。
- 硬い言い回しを避けてください。「〜に留まる」「〜に至った背景」「〜という構造」
  「〜の材料になる」「〜を担う」のような言葉は、平たい言葉に言い換えます。
  例: 「判断に至った背景を残す」→「なぜそうしたかをメモしておく」
- 伝えることは一つに絞ってください。記事の要点を全部入れようとしないこと。
- 2〜3文、全体で120字以内を目安にします。短いほど読まれます。

書き方:
- 最初の一文は、読み手が「あるある」と感じる具体的な状況にします。
  誰の話か（新卒／中途で入った人／管理職など）が分かるように書きます。
  「〜な場面があります」「〜な人がいます」「〜な組織があります」で始める型は
  使わないでください。状況そのものを書き始めます。
- 最後の一文で、記事が言っている一番のポイントを、平たい言葉で言い切ります。

守ること:
- threads の本文に URL や「noteに書きました」などの誘導を入れないでください。
  リンクは投稿後の返信で別に付けます。
- 文末はですます調。「〜だよね」「〜かも」「〜した。」のような言い切りは使わない。
- 「思い浮かべてください」のような命令形で始めない。「〜が必要です」「〜すべきです」
  のような諭す言い方で締めない。
- 別の人に読める言い方をしない（「中途採用の担当者」は人事の採用担当に読めます）。
- 記事本文にない事実を足さない。誰が誰に何をするのかを、本文どおりに保つ。
- 一部の人の話を、全員がそうであるかのように言い切らない。
- 会社や読み手を突き放すような、強すぎる言い方をしない。
"""
